...
public class Meta {
    ...
    public boolean equals(Object other) {
        ...
        Meta rhs = ((Meta) other);
        return new EqualsBuilder().append(limit, rhs.limit).append(name, rhs.name).append(number, rhs.number).append(additionalProperties, rhs.additionalProperties).isEquals();
    }
