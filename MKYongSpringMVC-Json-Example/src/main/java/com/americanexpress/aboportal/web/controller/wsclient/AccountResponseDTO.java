...
public class AccountResponseDTO {
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(accounts, rhs.accounts).append(accessToken, rhs.accessToken).append(additionalProperties, rhs.additionalProperties).isEquals();
    }
