...
public class CopyOfHttpsIgnoreCertificateNTransactionSummaryTestwithExecutor {
	
	private static Logger log = LoggerFactory.getLogger(CopyOfHttpsIgnoreCertificateNTransactionSummaryTestwithExecutor.class);
